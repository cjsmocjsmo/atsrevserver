...
curl -d '{"name": "charlie", "addr": "924 Hull Ave", "city": "Port Orchard", "phone": "505-555-1234", "email": "boo@gmail.com", "reqservdatestars": "02/15/2023", "comment": "job well done hellyea"}' -H "Content-Type: application/json" -X POST http://192.168.0.91:8080/insert_est;
curl -d '{"name": "charlie", "addr": "924 Hull Ave", "city": "Port Orchard", "phone": "505-555-1234", "email": "boo@gmail.com", "reqservdatestars": "02/15/2023", "comment": "job well done hellyea"}' -H "Content-Type: application/json" -X POST http://192.168.0.91:8080/insert_est;
